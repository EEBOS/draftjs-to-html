...
*/
function draftToHtml(editorContent, hashtagConfig, directional, customEntityTransform, blockRenderers) {
  var html = [];
  if (editorContent) {
    ...
    if (blocks && blocks.length > 0) {
      ...
      blocks.forEach(function (block) {
        if(blockRenderers && blockRenderers[block.type]) {
          html.push(blockRenderers[block.type](block, editorContent));
